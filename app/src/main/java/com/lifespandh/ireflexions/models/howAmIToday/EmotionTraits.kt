...
class EmotionTraits {
    ...
    companion object {
        ...
        val calmTraitCategory = TraitCategory1(0, "Calm", R.color.calm).apply {
        ...
        val madTraitCategory = TraitCategory1(1, "Mad", R.color.mad).apply {
        ...
        val scaredTraitCategory = TraitCategory1(2, "Scared", R.color.scared).apply {
        ...
        val powerfulTraitCategory = TraitCategory1(3,"Powerful", R.color.powerful).apply {
        ...
        val joyfulTraitCategory = TraitCategory1(4, "Joyful", R.color.joyful).apply {
        ...
        val sadTraitCategory = TraitCategory1(5, "Sad", R.color.sad).apply {
