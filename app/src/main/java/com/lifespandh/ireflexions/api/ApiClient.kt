...
import com.lifespandh.ireflexions.utils.network.ADD_SUPPORT_CONTACT
import com.lifespandh.ireflexions.utils.network.ADD_USER_TO_PROGRAM
import com.lifespandh.ireflexions.utils.network.DELETE_SUPPORT_CONTACT
import com.lifespandh.ireflexions.utils.network.EDIT_SUPPORT_CONTACT
import com.lifespandh.ireflexions.utils.network.GET_CARE_CENTER_EXERCISES
import com.lifespandh.ireflexions.utils.network.GET_COURSES
import com.lifespandh.ireflexions.utils.network.GET_EXERCISES
import com.lifespandh.ireflexions.utils.network.GET_JOURNAL_ENTRIES
import com.lifespandh.ireflexions.utils.network.GET_LESSONS
import com.lifespandh.ireflexions.utils.network.GET_PROGRAMS
import com.lifespandh.ireflexions.utils.network.GET_REGISTERED_PROGRAMS
import com.lifespandh.ireflexions.utils.network.GET_SUPPORT_CONTACTS
import com.lifespandh.ireflexions.utils.network.GET_SURVEY_QUESTIONS
import com.lifespandh.ireflexions.utils.network.GET_USER_PROGRAM_PROGRESS
import com.lifespandh.ireflexions.utils.network.LOGIN_CUSTOM_USER
import com.lifespandh.ireflexions.utils.network.LOGIN_USER
import com.lifespandh.ireflexions.utils.network.REFRESH_TOKEN
import com.lifespandh.ireflexions.utils.network.REGISTER_USER
import com.lifespandh.ireflexions.utils.network.SAVE_SURVEY_QUESTIONS
