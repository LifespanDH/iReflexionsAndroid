 ...
 * Use the [HowAmICreateEntryFragment.newInstance] factory method to
...
class HowAmICreateEntryFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment HowAmICreateEntryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HowAmICreateEntryFragment().apply {
